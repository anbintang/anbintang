...
- React fundamentals (components, props, state, hooks concepts)
- HTML, CSS, Bootstrap
- Responsive & cross-browser UI from Figma

**Backend & API**
- Laravel 8 (API, auth, business logic)
- RESTful APIs (HTTP methods)
- PostgreSQL, MySQL
- Basic security & performance practices

**Tooling & DevOps**
- Node.js (tooling), NPM, Webpack / Laravel Mix
- ESLint, Babel
- Git & GitLab (PRs, code reviews)
...
### 3. Nakula Sadewa Web-Based Tourism Information Center
